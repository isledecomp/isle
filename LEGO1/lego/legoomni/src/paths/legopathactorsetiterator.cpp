...
struct PathActorRrotateProbe : public PathActorTree {
	typedef void (PathActorTree::*Fn)(_Nodeptr);
	static Fn Get();
};

PathActorRrotateProbe::Fn PathActorRrotateProbe::Get()
{
	return &PathActorTree::_Rrotate;
}
