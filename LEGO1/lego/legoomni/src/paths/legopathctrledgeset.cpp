...
struct CtrlEdgeEraseProbe : public CtrlEdgeTree {
	typedef void (CtrlEdgeTree::*Fn)(_Nodeptr);
	static Fn Get();
};

CtrlEdgeEraseProbe::Fn CtrlEdgeEraseProbe::Get()
{
	return &CtrlEdgeTree::_Erase;
}
