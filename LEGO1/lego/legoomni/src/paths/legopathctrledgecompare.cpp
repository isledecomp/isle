...
struct CtrlEdgeCopyProbe : public CtrlEdgeTree {
	typedef _Nodeptr (CtrlEdgeTree::*Fn)(_Nodeptr, _Nodeptr);
	static Fn Get();
};

CtrlEdgeCopyProbe::Fn CtrlEdgeCopyProbe::Get()
{
	return &CtrlEdgeTree::_Copy;
}
