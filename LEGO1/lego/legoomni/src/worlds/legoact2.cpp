...
void LegoAct2::CheckBricksterIsLoose(MxS32 p_pathData)
{
	...
	if (objectId != (Act2mainScript::Script) 0) {
		Mx3DPointFloat lookingAtPepper(position);
		...
		StartAction(objectId, TRUE, TRUE, &position, &lookingAtPepper, NULL);
	}
}
